            ...
            function storeData(data) {
                ...
                data.map(function(flight) {
                    ...
                    if (flight.Remark) {
                        ...
                        let planeUp = '<svg xmlns="http://www.w3.org/2000/svg" fill="#0353a2" viewBox="0 0 640 512"><path d="M624 448H16c-8.8 0-16 7.2-16 16v32c0 8.8 7.2 16 16 16h608c8.8 0 16-7.2 16-16v-32c0-8.8-7.2-16-16-16zM80.6 341.3c6.3 6.8 15.1 10.7 24.3 10.7l130.5-.2a65.6 65.6 0 0 0 29.6-7.1l291-147.7c26.7-13.6 50.7-32.9 67-58.3 18.3-28.5 20.3-49.1 13.1-63.7-7.2-14.6-24.7-25.3-58.3-27.5-29.9-1.9-59.5 5.9-86.3 19.5l-98.5 50-218.7-82.1a17.8 17.8 0 0 0 -18-1.1L90.6 67.3c-10.7 5.4-13.3 19.7-5.2 28.5l156.2 98.1-103.2 52.4-72.4-36.5a17.8 17.8 0 0 0 -16.1 0L9.9 230.2c-10.4 5.3-13.2 19.1-5.6 28.1l76.2 83z"/></svg>';
